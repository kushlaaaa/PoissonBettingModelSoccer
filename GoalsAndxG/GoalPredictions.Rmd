...
for (i in 5:38){
  ...
  homedata <- data %>% select(Wk, Home, HomeGoals, AwayGoals)
  awaydata <- data %>% select(Wk, Away, AwayGoals, HomeGoals)
  
  homedata <- homedata %>% group_by(Home) %>% summarise(HomeGoals = mean(HomeGoals), AwayGoals = mean(AwayGoals))
  awaydata <- awaydata %>% group_by(Away) %>% summarise(AwayGoals = mean(AwayGoals), HomeGoals = mean(HomeGoals))
  
  homedata$HomeAttStrength <- (homedata$HomeGoals/(mean(homedata$HomeGoals)))
  homedata$HomeDefStrength <- (homedata$AwayGoals/(mean(homedata$AwayGoals)))
  awaydata$AwayAttStrength <- (awaydata$AwayGoals/(mean(awaydata$AwayGoals)))
  awaydata$AwayDefStrength <- (awaydata$HomeGoals/(mean(awaydata$HomeGoals)))
  ...
  pred_data$HomePred <- pred_data$HomeAttStrength*pred_data$AwayDefStrength*mean(homedata$HomeGoals)
  pred_data$AwayPred <- pred_data$AwayAttStrength*pred_data$HomeDefStrength*mean(awaydata$AwayGoals)
...
write_csv(final_pred, "PL_2017_2018_Pred_Goal.csv")
...
write_csv(final_pred, "PL_2018_2019_Pred_Goal.csv")
...
write_csv(final_pred, "LaLiga_2017_2018_Pred_Goal.csv")
...
write_csv(final_pred, "LaLiga_2018_2019_Pred_Goal.csv")
...
write_csv(final_pred, "Bunde_2017_2018_Pred_Goal.csv")
...
write_csv(final_pred, "Bunde_2018_2019_Pred_Goal.csv")
...
write_csv(final_pred, "Ligue1_2017_2018_Pred_Goal.csv")
...
write_csv(final_pred, "Ligue1_2018_2019_Pred_Goal.csv")
...
write_csv(final_pred, "SerieA_2017_2018_Pred_Goal.csv")
...
write_csv(final_pred, "SerieA_2018_2019_Pred_Goal.csv")
